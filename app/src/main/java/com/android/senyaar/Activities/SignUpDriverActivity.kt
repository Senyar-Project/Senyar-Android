...
import kotlinx.android.synthetic.main.activity_signup_driver.*
import me.drakeet.materialdialog.MaterialDialog

class SignUpDriverActivity : AppCompatActivity(), SignUpView {
    ...
    override fun initView() {
        ...
        text_terms_and_condition.text =
            Html.fromHtml("Agree to <font color='#6D9FFF'><b><big>Terms & Conditions </b></big></font>")
        bt_register.setOnClickListener {
            presenter?.verifyDriverFields(
                first_name.text.toString(),
                last_name.text.toString(),
                email.text.toString(),
                password.text.toString(),
                confirm_password.text.toString(),
                mobile_number.text.toString(), vehicle_number.text.toString(),
                licence_number.text.toString(), credit_number.text.toString(),
